...
from extract import build_datastore_with_nll_from_chunks, run_batch
...
ds_keys, ds_values, ds_nll = build_datastore_with_nll_from_chunks(gpt, chunks["datastore"], batch_size=256)

n_clusters = 500  # same as random_partition/minibatch_kmeans, for a fair comparison
compressed_keys, compressed_dists = utility_weighted_partition(ds_keys, ds_values, ds_nll, n_clusters=n_clusters, seed=42)
...
results = {
    "phase": "C9_utility_weighted_baseline",
    "model": "gpt2",
    "seq_len": 128,
...
save_results("results/utility_weighted_baseline.json", results)
...
print("mean utility_weighted DIME NLL:", mean_nll_mixed)
